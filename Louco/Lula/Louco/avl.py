...
class bancodedados(object):
    ...
    keyword = property(_avl.bancodedados_keyword_get, _avl.bancodedados_keyword_set)
...
def novoProjeto(root, projeto, email, telefone, finalizado, ferramentas, descricao, classe, keyword):
    return _avl.novoProjeto(root, projeto, email, telefone, finalizado, ferramentas, descricao, classe, keyword)

def buscarProjeto(root, projeto):
    return _avl.buscarProjeto(root, projeto)

def listarprojetos(root):
    return _avl.listarprojetos(root)

def escrever(root):
    return _avl.escrever(root)

def criaprojeto(projeto, email, telefone, finalizado, ferramentas, descricao, classe, keyword):
    return _avl.criaprojeto(projeto, email, telefone, finalizado, ferramentas, descricao, classe, keyword)

def addprojeto(root, projeto, email, telefone, finalizado, ferramentas, descricao, classe, keyword):
    return _avl.addprojeto(root, projeto, email, telefone, finalizado, ferramentas, descricao, classe, keyword)

def verifierProjeto(root, projeto):
    return _avl.verifierProjeto(root, projeto)
...
def compararStrings(string1, string2):
    return _avl.compararStrings(string1, string2)
class list(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
